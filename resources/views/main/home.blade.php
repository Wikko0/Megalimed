    ...
    <section class="product spad">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8">
                    <ul class="filter__controls">
                        ...
                        <li data-filter=".joggers">Joggers</li>
            ...
            <div class="row property__gallery">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix joggers">
                    <div class="product__item">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix classic">
                    <div class="product__item">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix women men classic accessories joggers">
