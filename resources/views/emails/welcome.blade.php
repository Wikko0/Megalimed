...
<head>
    ...
    <title>Добре дошли в МегалиМед</title>
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                            ...
                            <tr  >
                                <td align="center" class="center-text">
                                    <img style="width:190px;border:0px;display: inline!important;" src="{{ asset('img/logo.png') }}" width="190" border="0"       alt="intro">
                                </td>
                            </tr>
                            <tr  >
                                <td height="40" style="font-size:40px;line-height:40px;" >&nbsp;</td>
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:42px;line-height:52px;font-weight:400;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <div  >
                                        Здравей! Добре дошъл в МегалиМед общността!
                                    </div>
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <div  >
                                        Ние сме онлайн магазин за медицинско облекло
                                    </div>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="center-float">
                                        <tr>
                                            <td align="center"    bgcolor="#d6df58" style="border-radius: 6px;">
                                                ...
                                                <a href="https://megalimed.com" target="_blank"    style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:16px;line-height:19px;font-weight:700;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;padding: 20px 50px 20px 50px;display: inline-block;"><span>ОНЛАЙН МАГАЗИН</span></a>
                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="70" style="width:70px;max-width:70px;">
                                                    <tr  >
                                                        <td align="center">
                                                            <img style="display:block;width:100%;max-width:70px;border:0px;"    width="70" src="{{ asset('img/emails/Email-1_Icon-1.png') }}" border="0"  alt="icon">
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
                                                ...
                                                <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="480" style="width:480px;max-width:480px;">
                                                    ...
                                                    <tr  >
                                                        <td class="center-text container-padding"  align="left" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                                            ...
                                                            <div  >
                                                               Нашият уеб магазин е създаден специално за вашите нужни за избор на медицинско облекло
                                                            </div>
                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="70" style="width:70px;max-width:70px;">
                                                    <tr  >
                                                        <td align="center">
                                                            <img style="display:block;width:100%;max-width:70px;border:0px;"    width="70" src="{{ asset('img/emails/Email-1_Icon-2.png') }}" border="0"  alt="icon">
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
                                                ...
                                                <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="480" style="width:480px;max-width:480px;">
                                                    ...
                                                    <tr  >
                                                        <td class="center-text container-padding"  align="left" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                                            ...
                                                            <div  >
                                                                Можеш да избираш от многобройни категории медицинско облекло. Разгледай магазина и избери твоя най-подходящ екип.
                                                            </div>
                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="70" style="width:70px;max-width:70px;">
                                                    <tr  >
                                                        <td align="center">
                                                            <img style="display:block;width:100%;max-width:70px;border:0px;"    width="70" src="{{ asset('img/emails/Email-1_Icon-3.png') }}" border="0"  alt="icon">
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
                                                ...
                                                <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="480" style="width:480px;max-width:480px;">
                                                    ...
                                                    <tr  >
                                                        <td class="center-text container-padding"  align="left" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                                            ...
                                                            <div  >
                                                                Поръчай и ние ще се постараем да доставим възможно най-бързо твоята поръчка!
                                                            </div>
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                                                        ...
                                                        <td   class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                                ...
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td width="10"></td>
                                                                        <td align="center">
                                                                            <a href="https://www.facebook.com/MegaliMed"><img style="width:36px;border:0px;display: inline!important;" src="{{ asset('img/emails/Facebook.png') }}" width="36" border="0"       alt="icon"></a>
                                                                        </td>
                                                                        <td width="10"></td>
                                                                    </tr>
                                                                </table>
                                                        ...
                                                        <td   class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td width="10"></td>
                                                                        <td align="center">
                                                                            <a href="https://www.instagram.com/megalimed"><img style="width:36px;border:0px;display: inline!important;" src="{{ asset('img/emails/Instagram.png') }}" width="36" border="0"       alt="icon"></a>
                                                                        </td>
                                                                        <td width="10"></td>
                                                                    </tr>
                                                                </table>
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <a href="tel:089 988 9486"    style="color:#6e6e6e;"><span>089 988 9486</span></a>
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <a href="mailto:megalimedinfo@gmail.com"    style="color:#6e6e6e;"><span>megalimedinfo@gmail.com</span></a> - <a href="{{ url('/') }}"    style="color:#6e6e6e;"><span>{{ url('/') }}</span></a>
